        ...
        <form method="POST" action="{{ route('setting.update', $setting) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <label for="app_name" class="form-label required">
                        App Name
                    </label>
                ...
                <div class="col-md-6">
                    ...
                    <label for="login_title" class="form-label required">
                        Login Title
                    </label>
                ...
                <div class="col-md-12">
                    ...
                    <label for="copyright" class="form-label required">
                        Copyright
                    </label>
                ...
                <div class="col-md-3">
                    ...
                    <img id="preview" class="w-50 rounded mt-2"
                        src="{{ $setting->logo ? asset('storage/' . $setting->logo) : asset('niceadmin/img/logo.png') }}"
                        alt="Logo">
            ...
            <div class="text-end">
                ...
                <a href="{{ route('setting.index') }}" class="btn btn-warning">
                    Cancel
                </a>
